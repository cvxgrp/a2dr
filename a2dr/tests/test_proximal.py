...
class TestProximal(BaseTest):
    ...
    def test_sum_squares(self):
        ...
        x_a2dr = prox_sum_squares(self.v, self.t, scale = 2, offset = 0.5, lin_term = 1.5, quad_term = 1)
        x_cvxpy = self.prox_cvxpy(sum_squares, self.v, self.t, scale = 2, offset = 0.5, lin_term = 1.5, quad_term = 1)
        self.assertItemsAlmostEqual(x_a2dr, x_cvxpy, places = 4)
